...
(async function main() {
  ...
  try {
    ...
    const specs = [
      ...
      { label: 'scan-menu', path: '/test/scan-modes.html?case=menu&menu=1&intro=1&n=30&page=10&every=0', minimum: 30 },
      { label: 'scan-oldest', path: '/test/scan-modes.html?case=oldest&order=oldest&n=60&page=10&every=0', minimum: 14 },
      { label: 'scan-random', path: '/test/scan-modes.html?case=random&order=random&n=120&page=20&burst=10&every=0', minimum: 10 },
      { label: 'scan-album', path: '/test/scan-modes.html?case=album&menu=1&albpage=2&n=40&page=10&every=0', minimum: 30 },
      { label: 'scan-filters', path: '/test/scan-modes.html?case=filters&n=60&page=10&every=0', minimum: 10 },
